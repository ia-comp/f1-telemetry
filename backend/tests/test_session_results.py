...
class Test_Get_Session_Results:
    def test_valid_race(self):
        ...
        assert response.json()[0] == {"Driver": "Verstappen", "TeamColour": "3671C6", "LapTime": "1:12.272", "LapTimeDelta": 0.0}
        assert response.json()[19] == {"Driver": "Sargeant", "TeamColour": "37BEDD", "LapTime": "1:14.698", "LapTimeDelta": 2.427}
