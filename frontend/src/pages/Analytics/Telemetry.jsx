  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] px-8 py-10">
      ...
      <div className="flex flex-col lg:flex-row gap-6 justify-center items-stretch max-w-6xl mx-auto">
        ...
        {/* Lap Time card */}
        <div className="bg-[#262626] rounded-xl p-6 shadow-[0_0_15px_rgba(0,0,0,0.4)] flex flex-col items-center justify-center min-w-[200px]">
        ...
        {/* Circuit map card */}
        <div className="bg-[#262626] rounded-xl p-6 shadow-[0_0_15px_rgba(0,0,0,0.4)] flex flex-col items-center flex-1">
        ...
        <div className="bg-[#262626] rounded-xl p-6 shadow-[0_0_15px_rgba(0,0,0,0.4)] flex flex-col gap-6 flex-1">
